...
import { PaymentData, TransactionResult, TransactionStatus, PaymentMethodType } from '../domain/types';
...
// Factory de Gateways (Configuração viria de .env)
// PIX Adapter adicionado e colocado como primeiro da lista (default implícito se lógica de seleção pegar o primeiro)
const GATEWAYS = [
  new PixAdapter(),
