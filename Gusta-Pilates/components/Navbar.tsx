    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
            <div className="text-xl md:text-2xl font-black tracking-tighter text-white italic">
            GUSTA <span className="text-brand-500">PILATES</span>
            </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="p-2 rounded-full hover:bg-slate-800/50 text-slate-400 hover:text-white transition-all border border-transparent hover:border-slate-700 hidden sm:block"
